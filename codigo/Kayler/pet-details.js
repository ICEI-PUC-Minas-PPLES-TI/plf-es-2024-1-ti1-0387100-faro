document.addEventListener('DOMContentLoaded', function() {
    ...
    if (detalhesPet) {
        ...
        // Armazena o telefone do pet no botão de WhatsApp
        var whatsappButton = document.getElementById('whatsapp-button');
        whatsappButton.dataset.telefone = detalhesPet.telefone;
    } else {
...
function openWhatsApp() {
    var telefone = document.getElementById('whatsapp-button').dataset.telefone;
    if (telefone) {
        var whatsappUrl = 'https://api.whatsapp.com/send?phone=' + telefone.replace(/[^0-9]/g, '');
